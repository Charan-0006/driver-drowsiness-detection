# 4_train_eye_cnn.py
"""
Train eye open/closed classifier using flow_from_directory on datasets_cnn/eye
"""
...
DATA_ROOT = "datasets_cnn/eye"
IMG_SIZE = (224,224)
BATCH_SIZE = 32
EPOCHS = 8
WEIGHTS_OUT = "weights/eye_model.h5"
...
def train():
    train_gen = ImageDataGenerator(rescale=1./255,
                                   ...
                                   horizontal_flip=True).flow_from_directory(Path(DATA_ROOT)/"train", target_size=IMG_SIZE, batch_size=BATCH_SIZE, class_mode='binary')
